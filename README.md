...
- **Step / Turn 概览**：Viewer 详情面板用人类可读的概览替代低价值日志元数据，展示类型、位置、Task、状态和内容长度；Thinking 默认完整展开并可折叠。
...
**别再被 AI 当傻子糊弄了。Agent Lens 帮你看清一切。**
...
> "按照readme的指示，帮我装好 Agent Lens，链接是https://github.com/PacemakerG/CCWhat"
