...
class StepDiff:
    ...
    Attributes:
        ...
        action: Type of action - "add" for create/modify, "delete" for removal
    """
...
class StepDiffBuffer:
    ...
    def add_step(self, tool_name: str, file_path: str, diff: str, action: str = "add") -> int:
    ...
    def format_patch(self) -> str:
        ...
        for step in self.steps:
            ...
            action_label = "DELETE" if step.action == "delete" else "MODIFY"
            header = f"""# Step {step.step_index}: {step.tool_name} {action_label} {step.file_path}
